...
void merge(vector<int>& nums1, int m, vector<int>& nums2, int n) {
    if (n > 0) {
        int n1_i = m - 1;               // Index of current nums1 element, initialized as rightmost element in nums1, excluding 0s.
        int n2_i = n - 1;               // Index of current nums 2 element, initialized as rightmost element in nums2.
        int n1Zero_i = m + n - 1;       // Index of rightmost nums1 element that is a 0. 
        ...
        while (n2_i > -1) {
            ...
            // If the current element in nums1 is greater than the current element in nums2, move that element to n1Zero_i in nums1.
            else if (nums1[n1_i] > nums2[n2_i]) {
